...
const char versionStr[] = "Split Rail Pedal Power Utility Box ver. 1.8 . Features include Wattage output display";
...
boolean minusAlert = false;
char minusAlert1[] = "MORE";
char minusAlert2[] = "KIDS";
const float minusAlertVoltage = 14.0;
